...
// 할 일 앞의 완료 버튼. 미완료=빈 외곽선, 완료=채워진 방울 + pop 애니메이션.
const DROP_PATH =
...
export function TaskCheckbox({ checked, onToggle, disabled, ariaLabel }: TaskCheckboxProps) {
